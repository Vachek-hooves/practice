...
// alert("this function will find rectangle area if you enter 2 different numbers. In case you enter only one number function will find square area.  ")
...
function area (a,b){
    ...
    }else if ( a !== Number && a === NaN && b !== Number && b === NaN){
        num = b * 4 || a * 4;
