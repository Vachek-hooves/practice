...
let arr1 = fruits.concat(array, [5,6]); // створюється новий масив "arr" який перекопіює "fruits" і нові масиви.
// можливий і такий варіант
let arr = fruits.concat(array, fruits.slice(2), 5,6); // буде так само як і з масивом "arr1"
console.log(fruits); // масив fruits не змінився.
...
// якщо item буде в масиві, тоді його треба шукати циклами (циклами на вкладений цикл), якщо буде масив то звертатись forEach, якщо об'єкт то звертатись по ключу.
